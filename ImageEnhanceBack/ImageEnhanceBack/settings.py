"""
Django settings for ImageEnhanceBack project.
...
SECRET_KEY = 'django-insecure-rcx59f-#w5_!k0%^z4*#0vlcnz#c^&$=y&b73g$lj$#k4y%vka'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['8.155.30.228', '*']
...
WSGI_APPLICATION = 'ImageEnhanceBack.wsgi.application'
